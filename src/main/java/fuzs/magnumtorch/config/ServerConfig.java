...
public class ServerConfig extends AbstractConfig {
    ...
    public static abstract class TorchConfig extends AbstractConfig {
        ...
        List<String> mobBlacklistRaw = EntryCollectionBuilder.getKeyList(Registry.ENTITY_TYPE);
        ...
        List<String> mobWhitelistRaw = EntryCollectionBuilder.getKeyList(Registry.ENTITY_TYPE);
        ...
        protected void afterConfigReload() {
            ...
            this.mobBlacklist = EntryCollectionBuilder.of(Registry.ENTITY_TYPE).buildSet(this.mobBlacklistRaw);
            this.mobWhitelist = EntryCollectionBuilder.of(Registry.ENTITY_TYPE).buildSet(this.mobWhitelistRaw);
        }
    }
